        ...
        <div class="container mx-auto p-4">
            ...
            <div class="row m-4 p-4 gap-4 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-3">
                ...
                <div class="max-w-2xl bg-white shadow-lg rounded-lg overflow-hidden flex flex-col">
                    <div class="relative">
                        <img class="w-full h-48 object-cover" src="https://i.f1g.fr/media/sport24/616x347_cropupscale/var/plain_site/storage/images/athletisme/running/actualites/la-course-a-pied-bonne-pour-la-sante-687791/16936979-1-fre-FR/La-course-a-pied-bonne-pour-la-sante.jpg" alt="Course Image">
                    </div>
                    <div class="p-6 flex flex-col flex-grow">
                        ...
                        <div class="mt-4 space-y-2 flex-grow">
                            ...
                            <p class="text-gray-700"><strong>Course Duration:</strong> {{ $post->CourseDuration }}</p>
